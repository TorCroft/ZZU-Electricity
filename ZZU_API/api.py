...
class ZZU_API:
    ...
    def token_check(self, refresh_all = False, retry = True):
        if refresh_all:
            self.login()
    ...
    def get_energy_balance(self) -> str:
        """Return the balance of your energy bill."""
